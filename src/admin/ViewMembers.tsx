...
const ViewMembers = () => {
  ...
  const fetchMembers = async () => {
    try {
      ...
      const memberList: Member[] = snapshot.docs.map((memberDoc) => ({
        id: memberDoc.id,
  ...
  const handleUpdate = async () => {
    ...
    if (!selectedMember.designation.trim()) {
    ...
    try {
      ...
      await updateDoc(
        doc(db, "members", selectedMember.id),
        {
          ...
          nameBn: selectedMember.nameBn?.trim() || "",

          designation: selectedMember.designation.trim(),

          designationBn:
            selectedMember.designationBn?.trim() || "",

          memberType: selectedMember.memberType.trim(),
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const templateParams = {
        to_email: emailMember.email.trim(),
        ...
        name: "Badhokhali Youth Foundation",

        email: "badhokhaliyouthfoundation@gmail.com",
      };
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              className={`d-flex align-items-center justify-content-end gap-1 mt-1 ${isMe
                                  ? "text-success"
                                  : "text-muted"
                                }`}
                              style={{
